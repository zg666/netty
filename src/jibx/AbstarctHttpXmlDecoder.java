 ...
 */
public class AbstarctHttpXmlDecoder<T> extends
   MessageToMessageDecoder<T>{
	...
	private final static Charset UTF-8=Charset.forName(CHARSET_NAME);
	
	protected AbstarctHttpXmlDecoder(Class<?> clazz){
		this(clazz,false);
	}
	
	protected AbstrctHttpXMlDecoder(Class<?> clazz,boolean isPrint){
		this.clazz=clazz;
	...
	protected Object decode0(ChannelHandlerContext arg0,ByteBuf body) throws Exception{
		...
		IUnmarshllingContext uctx=factory.createUnmarshallingContext();
